...
def main():
    try:
        ...
        customer_name = "EB061- Weekly Data"  # Change this as needed
        ...
        #time.sleep(10)
        #downloaded_folder = r"C:\Users\shubham.bharadwaj\Desktop\python_ev_code\data\translink_ulsterbus_SD_E"

        # Step 4: Organize downloaded files
        logger.info("Organizing downloaded files...")
        organizer = FileOrganizer(VehicleNamesEV)  # Pass the pre-loaded vehicle data
        organizer.unzip_and_organize(downloaded_folder)

        #time.sleep(10)
        
       # Step 6: Process bus operations data
        ...
        # Step 8: Format the final Excel file 
